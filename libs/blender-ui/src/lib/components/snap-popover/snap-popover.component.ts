...
import { BuiSegmentedControlComponent, BuiSegmentOption } from '../segmented-control/segmented-control.component';
...
import { BuiPopoverContainerComponent, BuiPopoverHeaderComponent, BuiPopoverSectionComponent } from '../popover';
